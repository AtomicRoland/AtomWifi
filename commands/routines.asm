...
; On exit C=1 if escape is pressed and 0 if not
.check_esc
 pha                                \ save registers
 txa
 pha
 ...
 cpy #&3B                           \ check for escape scan code
 beq check_esc_pressed              \ jump if escape is pressed
 clc                                \ clear carry
 bcc check_esc_end                  \ jump always
.check_esc_pressed
 sec                                \ set carry to indicate escape is pressed
.check_esc_end
